...
export default function DocumentDownloader({ tramiteName }: DocumentDownloaderProps) {
  ...
  return (
    <div className="bg-background rounded-lg p-4 space-y-3">
        <h3 className="font-bold text-center text-primary-foreground">Tu {tramiteName} está listo</h3>
        <Button asChild className="w-full bg-accent hover:bg-accent/90 text-accent-foreground">
            <a href={documentUrl} download={`Certificado_${tramiteName.replace(/\s+/g, '_')}.pdf`}>
